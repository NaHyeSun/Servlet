...
public class SessionListenerTest implements HttpSessionListener, HttpSessionAttributeListener {
    ...
    public void attributeAdded(HttpSessionBindingEvent event) {
        ...
        System.out.println("session에 추가된 attribute" + event.getName() +", " + event.getValue());
    }

    @Override
    public void attributeRemoved(HttpSessionBindingEvent event) {
        System.out.println("session attribute 삭제");
        System.out.println("session에 삭제된 attribute" + event.getName() +", " + event.getValue());
    }

    @Override
    public void attributeReplaced(HttpSessionBindingEvent event) {
        System.out.println("session attribute 수정");
        System.out.println("session에 수정된 attribute" + event.getName() +", " + event.getValue());
